<header>
  ...
  <a href=""	class="header__logo"><img src="img/1.png"></a>
  <nav	class="menu">	
  <ul	class="menu__list">
  ...
  <li><a href=""	class="menu__courseslink">Front-end	developer</a>
  </li></ul></div>
  </li>
  ...
  <li><a href=""	class="menu__courseslink2">Team</a></li>
  <li><a href=""	class="menu__courseslink2">Community</a>
  </li></ul></div></li>
  <button class="autho">Authorization</button>
</ul>
